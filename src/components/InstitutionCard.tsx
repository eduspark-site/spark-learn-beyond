...
const InstitutionCard: React.FC<InstitutionCardProps> = ({
  ...
  // MAIN SITE: no popup — open external links directly
  ...
  return (
    <motion.div
      ...
      className={cn("relative group cursor-pointer", featured && "md:col-span-2")}
    >
      ...
      >
          ...
          <motion.img
            ...
            onError={(e) => {
              (e.target as HTMLImageElement).src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
                name
              )}&background=D4AF37&color=0A1628&size=48&bold=true`;
            }}
          />
        </motion.div>
        ...
        {subtitle && <p className="text-xs text-muted-foreground italic mb-2">{subtitle}</p>}
